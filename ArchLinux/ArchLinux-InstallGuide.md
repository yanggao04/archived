...
<img src="./.ArchLinux-InstallGuide.assets/1-1-3.png" alt="1-3" style="zoom:75%;" />

`lsblk -f`

![1-1](./.ArchLinux-InstallGuide.assets/1-1-1.png)

`fdisk -l`

<img src="./.ArchLinux-InstallGuide.assets/1-1-2.png" alt="1-1-2" style="zoom:75%;" />

then, cfdisk /dev/xxx to enter *xxx* disk to partition it

<img src="./.ArchLinux-InstallGuide.assets/1-2.png" alt="1-2" style="zoom:75%;" />

It will appear

<img src="./.ArchLinux-InstallGuide.assets/1-3.png" alt="1-3" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/1-4.png" alt="1-4" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/1-4-2.png" alt="1-4-2" style="zoom:40%;" />

Using `Type` at the bottom to modify the size type to **EFI System**

<img src="./.ArchLinux-InstallGuide.assets/1-4-3.png" alt="1-4-3" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/1-4-4.png" alt="1-4-4" style="zoom:40%;" />

[Optional] Create a  partition for swap

Still, `NEW` a partition of any size for swap, here we use 4G

<img src="./.ArchLinux-InstallGuide.assets/1-4-5.png" alt="1-4-5" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/1-4-6.png" alt="1-4-6" style="zoom:40%;" />

Using `Type` to modify the size type to **Linux swap**

<img src="./.ArchLinux-InstallGuide.assets/1-4-7.png" alt="1-4-7" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/1-4-8.png" alt="1-4-8" style="zoom:40%;" />

The rest space will go to root partition

<img src="./.ArchLinux-InstallGuide.assets/1-4-9.png" alt="1-4-9" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/1-4-10.png" alt="1-4-10" style="zoom:40%;" />

Let the type be the default one, i.e. **Linux filesystem**

<img src="./.ArchLinux-InstallGuide.assets/1-4-11.png" alt="1-4-11" style="zoom:40%;" />

Take `Write` and enter `yes` to write. Then using `Quit` to get back to the command line

<img src="./.ArchLinux-InstallGuide.assets/1-4-12.png" alt="1-4-12" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/1-4-13.png" alt="1-4-13" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/1-4-14.png" alt="1-4-14" style="zoom:60%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/1-5-1.png" alt="1-5" style="zoom:60%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/1-5-2.png" alt="1-5-2" style="zoom:75%;" />

`mkfs.fat -F 32 /dev/[EFI]` to format the EFI partition. Here it will be `mkfs.fat -F 32 /dev/sda1`.

<img src="./.ArchLinux-InstallGuide.assets/1-5-3.png" alt="1-5-3" style="zoom:75%;" />

Reassure that everything is correct.

<img src="./.ArchLinux-InstallGuide.assets/1-5-4.png" alt="1-5-4" style="zoom:60%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/1-6-1.png" alt="1-6" style="zoom:75%;" />

`mount --mkdir /dev/[EFI] /mnt/boot` to mount partition for EFI to `/mnt/boot`. Here is `mount --mkdir /dev/sda1 /mnt`

<img src="./.ArchLinux-InstallGuide.assets/1-6-2.png" alt="1-6-2" style="zoom:75%;" />

`swapon /dev/[swap]` to set the swap sector. Here is `swapon /dev/sda2`

<img src="./.ArchLinux-InstallGuide.assets/1-6-3.png" alt="1-6-3" style="zoom:75%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/2-1.png" alt="2-1" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/2-2.png" alt="2-2" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/2-3.png" alt="2-3" style="zoom:75%;" />

`arch-chroot /mnt` to enter the system.

<img src="./.ArchLinux-InstallGuide.assets/2-4.png" alt="2-4" style="zoom:75%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-1.png" alt="3-1" style="zoom:70%;" />

#### editor

[optional] `pacman -Sy` to synchronise local package database with remote one

<img src="./.ArchLinux-InstallGuide.assets/3-2.png" alt="3-2" style="zoom:40%;" />

`pacman -S [editorname]` to install a command-line editor you'd like to use. Here is **vim**.

<img src="./.ArchLinux-InstallGuide.assets/3-3.png" alt="3-3" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-4-1.png" alt="3-4-1" style="zoom:50%;" />

<img src="./.ArchLinux-InstallGuide.assets/3-4-2.png" alt="3-4-2" style="zoom:40%;" />

*Note: for other languages, find the corresponding coding and un-comment the line*

`locale-gen` to load the language config

<img src="./.ArchLinux-InstallGuide.assets/3-4-3.png" alt="3-4-3" style="zoom:75%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-5-1.png" alt="3-5-1" style="zoom:75%;" />

enter `LANG=en_US.UTF-8`, write and save.

<img src="./.ArchLinux-InstallGuide.assets/3-5-2.png" alt="3-5-2" style="zoom:40%;" />

#### user and password

`passwd` to set the password for root. Note: password will be invisible in command line and need to type twice

<img src="./.ArchLinux-InstallGuide.assets/3-6.png" alt="3-6" style="zoom:75%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-7.png" alt="3-7" style="zoom:75%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-8-1.png" alt="3-8-1" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/3-8-2.png" alt="3-8-2" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-9-1.png" alt="3-9-1" style="zoom:75%;" />

<img src="./.ArchLinux-InstallGuide.assets/3-9-2.png" alt="3-9-2" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-11.png" alt="3-11" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-12-1.png" alt="3-12-1" style="zoom:70%;" />

<img src="./.ArchLinux-InstallGuide.assets/3-12-2.png" alt="3-12-2" style="zoom:65%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/3-12-3.png" alt="3-12-3" style="zoom:75%;" />

`grub-mkconfig -o /boot/grub/grub.cfg` to generate GRUB config file

<img src="./.ArchLinux-InstallGuide.assets/3-12-4.png" alt="3-12-4" style="zoom:75%;" />

#### network

`pacman -S networkmanager`

<img src="./.ArchLinux-InstallGuide.assets/3-13-1.png" alt="3-13-1" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/3-13-2.png" alt="3-13-2" style="zoom:40%;" />

`systemctl enable NetworkManager` to automatically boot `NetworkManager` when booting.

<img src="./.ArchLinux-InstallGuide.assets/3-13-3.png" alt="3-13-3" style="zoom:50%;" />

Finally, `exit` and `reboot`

Login to *root* and test the network via `ping [website]`

<img src="./.ArchLinux-InstallGuide.assets/3-13-4.png" alt="3-13-4" style="zoom:50%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/4-1-1.png" alt="4-1-1" style="zoom:40%;" />

When asking for the selection, just by defult select all.

<img src="./.ArchLinux-InstallGuide.assets/4-1-2.png" alt="4-1-2" style="zoom:40%;" />

<img src="./.ArchLinux-InstallGuide.assets/4-1-3.png" alt="4-1-3" style="zoom:40%;" />
...
<img src="./.ArchLinux-InstallGuide.assets/4-2.png" alt="4-2" style="zoom:40%;" />
